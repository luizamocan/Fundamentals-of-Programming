...
class TextFileRepository(MemoryRepository):
    def __init__(self, file_book, file_client, file_rental):
        super().__init__()
        self.__file_book = file_book
        self.__file_client = file_client
        self.__file_rental = file_rental
        self._books = []
        self._clients = []
        self._rentals = []
        self._load()
